...
const UserForm = (props) => {
    ...
    // * the function below works because it runs every time the componenet is re rendered
    // * (when the state has been changed)
    // * FURTHER DETAIL:
    // By default, hasBeenSubmitted is 
    // false. When the form is submitted 
    // this value in state will be set to true which 
    // will cause the form to re-render and the formMessage
